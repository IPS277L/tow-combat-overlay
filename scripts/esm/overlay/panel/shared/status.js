...
export function updatePanelWoundActionIndicator(panelElement, actor, {
  ...
  const currentLabel = String(currentEntry?.label ?? localizeMaybe("TOWCOMBATOVERLAY.Tooltip.Panel.WoundActions.Title", "Wound Actions")).trim();
  ...
  indicatorElement.dataset.tooltipTitle = localizeMaybe("TOWCOMBATOVERLAY.Tooltip.Panel.WoundActions.Title", "Wound Actions");
