...
export const PANEL_SELECTION_TEMPLATE_PATH =
  'modules/tow-combat-overlay/templates/overlay/control-panel-selection.hbs';
...
export const PANEL_REORDERABLE_GROUP_KEYS = new Set([
  'manoeuvre',
  'recover',
  'actions',
  'attacks',
