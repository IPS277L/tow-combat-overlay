const PANEL_SELECTION_SYNC_HOOKS = Object.freeze([
  ...
  {
    hookName: 'createActiveEffect',
    idKey: 'createActiveEffectHookId',
    callbackKey: 'onCreateActiveEffect'
  },
  {
    hookName: 'updateActiveEffect',
    idKey: 'updateActiveEffectHookId',
    callbackKey: 'onUpdateActiveEffect'
  },
  {
    hookName: 'deleteActiveEffect',
    idKey: 'deleteActiveEffectHookId',
    callbackKey: 'onDeleteActiveEffect'
  }
]);

export function createPanelSelectionSyncService({ updateSelectionDisplay } = {}) {
