export function createPanelDomLifecycleService({
  ...
  async function ensureControlPanel() {
    ...
    const hasMainPanel =
      controlPanelState.element instanceof HTMLElement && controlPanelState.element.isConnected;
    const hasSelectionPanel =
      controlPanelState.selectionElement instanceof HTMLElement &&
      controlPanelState.selectionElement.isConnected;
    ...
    syncSelectionPanelPosition(
      { element: panelElement, selectionElement: selectionPanelElement },
      panelSelectionGapPx
    );
    ...
    bindControlPanelDrag(controlPanelState, panelElement, {
      applyPosition: (state, element, left, top) =>
        applyPanelPositionWithSelectionClamp(
          state,
          element,
          left,
  ...
  function removeControlPanel() {
    ...
    removeStaleControlPanels({ panelId, selectionPanelId: panelSelectionId });
    if (game && Object.prototype.hasOwnProperty.call(game, panelStateKey))
      delete game[panelStateKey];
  }
