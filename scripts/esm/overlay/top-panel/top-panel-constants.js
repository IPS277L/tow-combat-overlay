...
export const TOP_PANEL_ORDER_STORAGE_KEY = 'tow-combat-overlay.top-panel-order.v1';
export const TOP_PANEL_POSITION_STORAGE_KEY = 'tow-combat-overlay.top-panel-position.v1';
export const TOP_PANEL_VIEWPORT_MARGIN_PX = 8;
export const TOP_PANEL_FOCUS_ZOOM_SCALE = 1.5;
export const TOP_PANEL_FOCUS_ANIMATION_MS = 300;
export const TOP_PANEL_CHIP_TOOLTIP_FALLBACK = 'No description.';
export const TOP_PANEL_CHIP_MAX_PER_ROW = 17;
export const TOP_PANEL_WOUND_STATE_KEYS = Object.freeze(
  new Set(['unwounded', 'wounded', 'defeated'])
);
