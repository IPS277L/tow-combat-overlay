import {
  getTowCombatOverlayActionsApi,
  getTowCombatOverlayPublicApi
} from '../../api/module-api-registry.js';
import { getTowCombatOverlayConstants } from '../../runtime/module-constants.js';

const { apiKeys: COMBAT_OVERLAY_API_KEYS, notifications: MODULE_NOTIFICATIONS } =
...
export async function towCombatOverlayEnsureActionsApiRuntime() {
  ...
  return (
    typeof api?.attackActor === 'function' &&
